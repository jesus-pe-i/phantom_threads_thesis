...
dgp <- eval({
  {
      ...
      make_A_core_periphery(n_units = n_units, m = m, p_lags = p_lags, 
          core_units = c(1L, 2L, 3L, 4L), self_diag = c(0.35, 0.04), 
          self_off = c(0.35, 0.04)/6, self_diag_sign = 1, self_off_sign = 1, 
          self_off_pattern = "alternating", core_core_diag = c(0.045, 
              0.024), core_to_periphery_diag = c(0.04, 0.02), periphery_to_core_diag = c(0, 
              0), periphery_to_periphery_diag = c(0, 0), core_core_diag_sign = 1, 
