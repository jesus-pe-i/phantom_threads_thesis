...
dgp <- eval({
  {
      ...
      make_A_community_block(n_units = n_units, m = m, p_lags = p_lags, 
          communities = list(c(1L, 2L), c(3L, 4L, 5L), c(6L, 7L, 
              8L), c(9L, 10L)), self_diag = c(0.46, 0.037), self_off = c(0.42, 
              0.037)/6, self_diag_sign = 1, self_off_sign = 1, 
          self_off_pattern = "alternating", within_diag = c(0.05, 
