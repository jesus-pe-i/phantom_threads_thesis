...
dgp <- eval({
  {
      ...
      make_A_hub(n_units = n_units, m = m, p_lags = p_lags, sender_hub_units = c(1L), 
          receiver_hub_units = c(8L), self_diag = c(0.54, 0.05), 
          self_off = c(0.54, 0.05)/6, self_diag_sign = 1, self_off_sign = 1, 
          self_off_pattern = "alternating", sender_hub_diag = c(0.058, 
              0.025), receiver_hub_diag = c(0.055, 0.02), hub_to_hub_diag = c(0.09, 
              0.027), background_diag = c(0, 0), sender_hub_diag_sign = 1, 
