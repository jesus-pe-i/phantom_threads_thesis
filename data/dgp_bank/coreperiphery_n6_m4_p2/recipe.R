...
dgp <- eval({
  {
      ...
      make_A_core_periphery(n_units = n_units, m = m, p_lags = p_lags, 
          core_units = c(1L, 2L), self_diag = c(0.51, 0.05), self_off = c(0.45, 
              0.05)/6, self_diag_sign = 1, self_off_sign = 1, self_off_pattern = "alternating", 
          core_core_diag = c(0.06, 0.03), core_to_periphery_diag = c(0.05, 
              0.025), periphery_to_core_diag = c(0, 0), periphery_to_periphery_diag = c(0, 
