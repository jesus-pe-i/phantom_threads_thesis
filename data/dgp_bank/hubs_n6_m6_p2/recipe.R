...
dgp <- eval({
  {
      ...
      make_A_hub(n_units = n_units, m = m, p_lags = p_lags, sender_hub_units = c(1L), 
          receiver_hub_units = c(6L), self_diag = c(0.44, 0.035), 
          self_off = c(0.43, 0.035)/6, self_diag_sign = 1, self_off_sign = 1, 
          self_off_pattern = "alternating", sender_hub_diag = c(0.038, 
              0.015), receiver_hub_diag = c(0.035, 0.013), hub_to_hub_diag = c(0.06, 
              0.018), background_diag = c(0, 0), sender_hub_diag_sign = 1, 
