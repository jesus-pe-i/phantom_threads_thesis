...
dgp <- eval({
  {
      ...
      make_A_community_block(n_units = n_units, m = m, p_lags = p_lags, 
          ...
          self_off = c(0.47)/6, self_diag_sign = 1, self_off_sign = 1, 
          self_off_pattern = "alternating", within_diag = c(0.06), 
          between_diag = 0, within_diag_sign = 1, within_off_sign = 1, 
