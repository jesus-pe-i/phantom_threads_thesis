...
dgp <- eval({
  {
      ...
      make_A_core_periphery(n_units = n_units, m = m, p_lags = p_lags, 
          core_units = c(1L), self_diag = c(0.555, 0.06), self_off = c(0.55, 
              0.06)/6, self_diag_sign = 1, self_off_sign = 1, self_off_pattern = "alternating", 
          core_core_diag = c(0.08, 0.04), core_to_periphery_diag = c(0.065, 
              0.03), periphery_to_core_diag = c(0, 0), periphery_to_periphery_diag = c(0, 
