...
dgp <- eval({
  {
      ...
      make_A_core_periphery(n_units = n_units, m = m, p_lags = p_lags, 
          core_units = c(1L, 2L), self_diag = c(0.68, 0.07), self_off = c(0.65, 
              0.07)/6, self_diag_sign = 1, self_off_sign = 1, self_off_pattern = "alternating", 
          core_core_diag = c(0.1, 0.06), core_to_periphery_diag = c(0.09, 
              0.05), periphery_to_core_diag = c(0, 0), periphery_to_periphery_diag = c(0, 
